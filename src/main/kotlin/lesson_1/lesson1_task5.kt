...
fun main() {
    ...
    val timeString: String =
        getTimeFromSeconds(seconds)    // вызов функции с сохранением ее возвращаемого значения в переменную
...
fun getTimeFromSeconds(inputSecondCounter: Int): String {
    ...
    val minutes: Int =
        (inputSecondCounter % 3600) / 60    // берем остаток от деления на 3600 и делим на 60 получаем минуты
